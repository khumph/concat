...
#'
#' @param tlfs Data frame with two columns, "title" with the title of each TLF and "path" with the path to the pdf file for the TLF.
...
")
  ...
  text <- paste0(
    "\\phantomsection\n",
    "\\addcontentsline{toc}{subsection}{", tlfs$title, "}\n",
    "\\includepdf[pages=-, pagecommand = {}]{", tlfs$path, "}\n\n"
  )
